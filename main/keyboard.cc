...
esp_err_t Keyboard::InitializeKeys(i2c::Operation& op) {
  constexpr kbd::adp5589::reg::PIN_CONFIG_A reg_a = {
      .R7_CONFIG = 0,
      .R6_CONFIG = 0,
      .R5_CONFIG = 0,
      .R4_CONFIG = 0,
  ...
  constexpr kbd::adp5589::reg::PIN_CONFIG_B reg_b = {
      .C7_CONFIG = 0,
      .C6_CONFIG = 0,
      .C5_CONFIG = 0,
      .C4_CONFIG = 0,
  ...
  constexpr kbd::adp5589::reg::PIN_CONFIG_C reg_c = {
      .Reserved = 0,
      .C10_CONFIG = 0,
      .C9_CONFIG = 0,
      .C8_CONFIG = 0,
  ...
  constexpr kbd::adp5589::reg::PIN_CONFIG_D reg_d = {
...
esp_err_t Keyboard::InitializeInterrupts(i2c::Operation& op) {
  ...
  constexpr kbd::adp5589::reg::INT_EN reg = {
      .Reserved = 0,
      .LOGIC2_IEN = false,
      .LOGIC1_IEN = false,
      .LOCK_IEN = false,
...
esp_err_t Keyboard::Initialize() {
  ...
  {
    constexpr kbd::adp5589::reg::GENERAL_CFG_B reg = {
...
esp_err_t Keyboard::HandleEvents() {
  ...
  kbd::adp5589::reg::INT_STATUS interrupt_status;
  ...
  kbd::adp5589::reg::Status status_reg;
  err = Read(&status_reg);
  if (err != ESP_OK) {
  ...
  kbd::adp5589::reg::FIFO fifo[kMaxFIFOEntries];
...
esp_err_t Keyboard::Read(kbd::adp5589::reg::Status* reg) {
  uint8_t b;
...
esp_err_t Keyboard::Read(kbd::adp5589::reg::INT_STATUS* reg) {
  uint8_t b;
...
esp_err_t Keyboard::Read(kbd::adp5589::reg::FIFO* reg) {
  uint8_t b;
...
esp_err_t Keyboard::Read(kbd::adp5589::reg::ID* reg) {
  uint8_t b;
